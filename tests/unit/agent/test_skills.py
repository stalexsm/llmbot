...
class TestPromptBudget:
    ...
    # База выросла на правило о секретах: поведенческий прогон (#38) показал,
    # что без явного запрета модель выполняла cat .env и сливала токен.
    # Дальнейший рост бюджета — только осознанно, с обоснованием в промпте.
    _BASE_BUDGET_CHARS = 1350
